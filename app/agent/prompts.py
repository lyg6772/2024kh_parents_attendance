...
def _build_tools_section(registry: dict[str, ToolDefinition]) -> str:
    lines: list[str] = []
    for tool in registry.values():
        category_label = "쓰기" if tool.category.value == "write" else "읽기"
        lines.append(f"- **{tool.name}** [{category_label}]: {tool.summary}")
